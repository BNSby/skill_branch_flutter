...
class UserHolder {
  ...
  void registerUser(String name, String phone, String email) {
    ...
    if (users.containsKey(user.login)) throw Exception('A user with this name already exists');
  ...
  User registerUserByPhone(String fullName, String phone) {
    ...
    String validPhone = User.parsePhone(phone);

    if (users.containsKey(validPhone)) throw Exception('A user with this phone already exists');
